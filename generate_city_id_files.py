...
#Adapted from: https://raw.githubusercontent.com/csparpa/pyowm/master/scripts/generate_city_id_files.py
...
def read_all_cities_into_dict():
    ...
    cmd = ['gunzip', city_list_gz]
    subprocess.call(cmd)

    # All cities
    with open(city_list_gz.rstrip('.gz'), "r") as i:
